...
۝♡ۣۜۜ፝͜͜͡͡✿➤ PATUHI PERATURAN BOT/GRUP`,
               ...
               const menu = fs.readFileSync(`./imgnuy/mc.jpg`)
               nuy.sendMessage(from, menu, image, { quoted: mek, caption: teks });
               await costum(menu(prefix, instagram, yt, name, pushname2, user, limitt, uptime, jam, tanggal), text, Nurul, rmenu);
               break;
            case 'zodiak':
            ...
            case 'info':
               ...
               const daca = fs.readFileSync('./imgnuy/mc.jpg');
